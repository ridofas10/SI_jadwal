...
if (!$id_user) {
    echo "Anda harus login untuk melihat jadwal bimbingan.";
    exit;
}

// Query untuk mengambil data dari tabel jadwal_bimbingan berdasarkan id_user
$query = "
    SELECT 
        jb.id,
        jb.nama_dosen,
    ...
    WHERE jb.id_user = '$id_user'
    ORDER BY jb.tanggal, jb.hari, jb.jam
";
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <h4>Daftar Jadwal Bimbingan</h4><br>
                <!-- Input Pencarian -->
                        ...
                        <table class="table table-striped" id="jadwal-table">
                            ...
                            while ($row = mysqli_fetch_assoc($result)) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="cetak.php?id=<?= urlencode($row['id']); ?>"
                                            class="btn btn-success btn-sm">
                                            <i class="fas fa-print">&nbsp;</i>Cetak
                                        </a>
                                        <!-- fitur cetak -->
                                        <!-- <a href="hapus_jadwal_bimbingan.php?id=<?= urlencode($row['id']); ?>"
