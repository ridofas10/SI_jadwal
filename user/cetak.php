...
ob_start();
require_once('cetak_jadwal.php');  // Pastikan ini merujuk pada file yang berisi konten HTML untuk PDF
...
$nama_file = "Surat_Pengantar_Bimbingan_" . htmlspecialchars($row['nama_mahasiswa']) . "_" . date('d-m-Y_H-i-s') . ".pdf";
