...
ob_start();
require_once('cetak_kartu.php');  // Pastikan ini merujuk pada file yang berisi konten HTML untuk PDF
...
$nama_file = "Kartu_Bimbingan_" . htmlspecialchars($nama_mahasiswa) . "_" . date('d-m-Y_H-i-s') . ".pdf";
