...
// Query untuk mengambil seluruh data jadwal_bimbingan tanpa memerlukan id_user
$query = "
    SELECT 
        jb.id,
        jb.nama_dosen,
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div>
                    <a href="cetak.php" class="btn btn-primary" target="_blank"><i class="fas fa-print">&nbsp;</i>Cetak
                        Rekap</a>
                </div><br>
                <!-- Input Pencarian -->
                        ...
                        <table class="table table-striped" id="jadwal-table">
                            ...
                            while ($row = mysqli_fetch_assoc($result)) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="cetak2.php?id=<?= urlencode($row['id']); ?>"
